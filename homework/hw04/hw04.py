...
def mul_interval(x, y):
    ...
    value in y."""
    p1 = lower_bound(x) * lower_bound(y) # 2
    p2 = lower_bound(x) * upper_bound(y) # 4
    p3 = upper_bound(x) * lower_bound(y) # -4
    p4 = upper_bound(x) * upper_bound(y) # -8
